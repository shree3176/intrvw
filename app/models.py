...
class User(UserMixin, db.Model):
    ...
    def __init__(self, **kwargs):
        ...
        if self.role is None:
            if self.email == current_app.config['INTERVIEW_CONFIG']:
...
class ProjectRequirement(db.Model):
    ...
    proj_database = db.Column(db.String(64))
    proj_lang = db.Column(db.String(64))
    proj_desc = db.Column(db.String(64))

    def __repr__(self):
        return '<ProjectRequirement %r>' % self.full_name
